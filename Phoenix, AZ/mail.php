...
if (!empty($_POST)) {
$to = 'info@pho.efmoving.com';
$subject = 'Eagle & Falcon Moving Comany';
...
<body>
<h1>Eagle & Falcon Moving Comany - '.$location.'</h1>
<table>
...
$headers .= "From: Eagle & Falcon Moving Comany <pho.efmoving.com>\r\n";
if($phone!=''||$email!='') {
